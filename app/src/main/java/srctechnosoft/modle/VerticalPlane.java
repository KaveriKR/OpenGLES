...
public class VerticalPlane {
    ...
    public VerticalPlane(Context context){
        ...
        colorBuffer.position(0);
            ...
            bitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.and);// Allocate texture buffer. An float has 4 bytes. Repeat for 6 faces.
    ...
    private float[] vertices = {  // Vertices for the square
            -1.3f, -1.0f,  0.0f,  // 0. left-bottom
            1.3f, -1.0f,  0.0f,  // 1. right-bottom
            -1.3f,  1.0f, 0.0f,  // 2. left-top
            1.3f,  1.0f,  0.0f   // 3. right-top
    };
